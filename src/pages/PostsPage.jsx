    ...
    <div className="flex w-full flex-col gap-10">
      <header className="glass rounded-3xl px-6 py-8 shadow-xl md:px-10">
        ...
        <p className="mt-4 max-w-2xl text-base text-slate-600">
          Create, update, and delete sample posts using the JSONPlaceholder API.
          Changes are mocked, so refresh to reset.
        </p>
      ...
      <section className="grid gap-8 lg:grid-cols-[1.1fr_1.6fr]">
        ...
        >
          <h2 className="font-display text-2xl text-slate-900">Create a post</h2>
        ...
        <div className="space-y-5">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-500">Read + update + delete flows.</p>
            </div>
